# ============================================================================
# BULAN Ground Control Build Configuration Options
...
set(QGC_APP_NAME "BULAN Ground Control" CACHE STRING "Application name")
string(TIMESTAMP _copyright_year "%Y")
set(QGC_APP_COPYRIGHT "Copyright (c) ${_copyright_year} BULAN Ground Control. All rights reserved." CACHE STRING "Copyright notice")
set(QGC_APP_DESCRIPTION "BULAN Ground Control App" CACHE STRING "Application description")
set(QGC_ORG_NAME "BULAN" CACHE STRING "Organization name")
set(QGC_ORG_DOMAIN "bulangroundcontrol.com" CACHE STRING "Organization domain")
set(QGC_PACKAGE_NAME "com.bulan.groundcontrol" CACHE STRING "Package identifier")
...
# TODO(BULAN-LOGO): replace deploy/macos/qgroundcontrol.icns with BULAN macOS icon
...
# TODO(BULAN-LOGO): replace deploy/linux/QGroundControl_256.png with BULAN 256x256 icon
...
# TODO(BULAN-LOGO): replace deploy/linux/QGroundControl.svg with BULAN SVG icon
...
# TODO(BULAN-LOGO): replace deploy/windows/WindowsQGC.ico with BULAN Windows icon
